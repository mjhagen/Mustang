...
<cfset local.privileges = "create,view,change,delete,approve" />
    ...
    <div id="collapseRoleItems" class="panel-collapse collapse in">
      <div class="panel-body">
        <table class="table table-condensed table-bordered">
          ...
          <cfloop array="#local.role.getSecurityRoleItems()#" index="local.securityRole">
            <tr>
...
<cfoutput>#view( 'common:elements/edit', { formappend = local.formappend })#</cfoutput>