component extends="root.model.logged"
          ...
          joinColumn="id"
          schema="mustang" {
  property name="username" length="64" inform=true orderinform=1 editable=true inlist=true;
  ...
  property name="email" length="128" inform=true orderinform=5 editable=true;
  ...
  property name="contactLogEntries" singularName="contactLogEntry" fieldtype="one-to-many" cfc="root.model.logentry" FKColumn="contactid";
